...
PHASE_CONTRACTS: dict[str, PhaseContract] = {
    ...
    'phase11': PhaseContract(
        ...
        outputs=(
            'runtime/learning/phase11_feature_store.json',
            'runtime/learning/phase11_label_store.json',
            'runtime/learning/phase11_dataset.json',
            'runtime/quality/phase11_challenger_report.json',
            'runtime/latest/model_registry_latest.json',
            'runtime/quality/phase11_drift_report.json',
            'runtime/latest/retraining_recommendation_latest.json',
            'runtime/latest/run_manifest.json',
        ),
        reads=(
            'data/quarterly_history.csv',
        ...
        idempotent=True,
        failure_modes=(
            'phase11_dataset_validation_error',
            'phase11_temporal_split_error',
            'phase11_leakage_validation_error',
            'phase11_challenger_gate_rejection',
            'phase11_registry_validation_error',
        ),
    ),
    'all': PhaseContract(
        name='all',
