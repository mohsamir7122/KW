...
PHASE_CONTRACTS: dict[str, PhaseContract] = {
    ...
    'phase11': PhaseContract(
        name='phase11',
        inputs=(
            'runtime/learning/decision_outcome_history.json',
            'runtime/latest/run_manifest.json',
        ),
        outputs=(
        ...
        failure_modes=(
            ...
            'temporal_split_validation_error',
            'feature_label_leakage_detected',
            'challenger_acceptance_gate_failed',
            'drift_report_validation_error',
        ),
    ),
    'all': PhaseContract(
        name='all',
